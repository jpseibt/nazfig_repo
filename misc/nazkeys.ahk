...
#d::ToggleApp("Milton ahk_exe Milton.exe", "milton.bat")
#+d::ToggleApp("Rnote ahk_exe rnote.exe", "rnote.bat")
...
#w::ToggleApp("web.whatsapp.com ahk_exe chrome.exe", '"chrome.bat" --app=https://web.whatsapp.com')
